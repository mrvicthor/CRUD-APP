...
//Use the enter keypad to submit
...
const removeItem = e => {
  ...
  let itemToBeRemoved = item.parentNode.parentNode.innerText;
  let parent = itemToBeRemoved.parentNode;
...
const completedTask = e => {
  let item = e.currentTarget;
  let itemToBeEdited = item.parentNode.parentNode.innerText;

  document.querySelector("#item").value = itemToBeEdited;
